...
if __name__ == '__main__':
    ...
    args = parser = argparse.Namespace(datapath='./tmp-tokenization-kobert-data_test/data_ko', outdir='./encoded-data/kobert/data_test/data_ko', tokenizer='BM-K/KoSimCSE-roberta-multitask', overwrite=False, normalize_text=False)
    print(tokenize_file(args))
